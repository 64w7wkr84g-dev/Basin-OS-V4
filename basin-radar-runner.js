...
/**
 * Basin OS V6.3 Lead Factory Automation Runner
 *
 * Safe design:
...
(async function main(){
  ...
  fs.writeFileSync(out('data/radar-run-log.json'),JSON.stringify({lastRunAt:generatedAt,status:'complete',...radar.stats,message:`V6.3 created ${associateReady.length} associate-ready leads.`},null,2));
  console.log(`V6.3 complete: ${associateReady.length} associate-ready, ${research.length} research, ${searchCount} public searches.`);
